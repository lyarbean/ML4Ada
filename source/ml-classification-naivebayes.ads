...
package ML.Classification.Naivebayes is
   ...
   type Classifier_Type is interface;

   procedure Train
      (Classifier : in out Classifier_Type; Event : Event_Type'Class) is
      abstract;
   procedure Done
      (Classifier : in out Classifier_Type) is abstract;
   procedure Predict
      (Classifier : Classifier_Type; Event : in out Event_Type'Class) is
      abstract;
   ...
   procedure Handle
      (Priori : in out Priori_Type; Variable : Variable_Type'Class) is
      abstract;
